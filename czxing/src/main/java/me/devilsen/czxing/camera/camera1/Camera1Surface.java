 ...
 * desc : 摄像头预览画面
 */
public class Camera1Surface extends SurfaceView implements SensorController.CameraFocusListener,
    ...
    public Camera1Surface(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Camera1Surface(Context context, AttributeSet attrs, int defStyleAttr) {
