...
Java_me_devilsen_czxing_BarcodeReader_createInstance(JNIEnv* env, jobject thiz, jintArray formats)
{
	try
	{
...
Java_me_devilsen_czxing_BarcodeReader_destroyInstance(JNIEnv* env, jobject thiz, jlong objPtr)
{
	try
	{
...
Java_me_devilsen_czxing_BarcodeReader_readBarcode(JNIEnv* env, jobject thiz, jlong objPtr, jobject bitmap, jint left, jint top, jint width, jint height, jobjectArray result)
{
	try
	{
